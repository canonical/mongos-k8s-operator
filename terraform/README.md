# Terraform module for mongos-k8s-operator
...
```
resource "juju_model" "mongos-k8s" {
  name = mongos-k8s
}

module "mongos-k8s-operator" {
  source = "<path-to-this-directory>"
  model_name = juju_model.mongos-k8s.name
}
```
...
```
data "juju_model" "mongos-k8s" {
  name = var.model_name
}

module "mongos-k8s" {
  source = "<path-to-this-directory>"
  model_name = data.juju_model.mongos-k8s.name
}
```